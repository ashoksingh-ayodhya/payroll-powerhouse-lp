...
const SEO_TITLE = "WPS Payroll & Salary Card UAE | Edenred Payroll for Business";
const SEO_DESC =
          ...
          "@graph": [
            {
              "@type": "Organization",
              name: "Edenred UAE",
              url: "https://edenred.ae",
              logo: IMG.logo,
              sameAs: ["https://edenred.ae"],
            },
            {
              "@type": "Product",
              name: "Edenred Payroll – WPS Salary Card & Payroll Solution",
              brand: "Edenred",
              description: SEO_DESC,
              image: IMG.heroComposite,
              aggregateRating: {
            ...
            },
            {
              ...
              mainEntity: [
                {
                  "@type": "Question",
                  name: "What is WPS and is Edenred Payroll WPS-compliant?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "The Wage Protection System (WPS) is an electronic salary transfer system mandated by the UAE Ministry of Human Resources and Emiratisation (MoHRE). Edenred Payroll is fully WPS-compliant and authorised, with no minimum salary requirement.",
                  },
                },
                {
                  "@type": "Question",
                  name: "How does the Edenred salary card work for employees?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Employees receive a Mastercard-powered C3Pay salary card. Salaries are credited directly to the card, and employees can withdraw cash at any ATM, pay online or in-store worldwide, send money home, and recharge mobiles in 130+ countries.",
                  },
                },
                {
                  "@type": "Question",
                  name: "How fast can my business start running payroll with Edenred?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Once your KYC documents are submitted, onboarding takes a matter of days. You can begin issuing payroll cards and processing salaries from the Edenred Payroll dashboard immediately after activation.",
                  },
                },
                {
                  "@type": "Question",
                  name: "Is there a minimum company size or salary requirement?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "No. Edenred Payroll works for businesses of every size, with no minimum salary requirement — WPS or non-WPS.",
                  },
                },
              ],
            },
    ...
    <header className="sticky top-0 z-50 w-full backdrop-blur-md bg-background/80 border-b border-border">
      <div className="mx-auto max-w-7xl px-5 lg:px-8 h-16 flex items-center justify-between">
        <a href="#top" className="flex items-center gap-2">
          <img src={IMG.logo} alt="Edenred UAE" className="h-8 w-auto" />
        </a>
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-navy">
          <a href="#features" className="hover:text-primary transition-colors">Why Edenred</a>
          ...
          <a href="#wps" className="hover:text-primary transition-colors">WPS & Compliance</a>
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8 pt-14 pb-20 lg:pt-20 lg:pb-28 grid lg:grid-cols-12 gap-10 items-center">
        <div className="lg:col-span-7">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a
              href="https://wa.me/971564016582"
              className="inline-flex items-center gap-2 rounded-full border border-border bg-background px-6 py-3.5 text-sm font-semibold text-navy hover:bg-muted"
            >
              <PhoneCall className="h-4 w-4 text-primary" /> Chat with Sales
            </a>
          </div>
...
function Features() {
  const features = [
    {
      icon: ShieldCheck,
      title: "Secure & WPS Compliant",
      desc: "Bank-grade data security and full WPS compliance in the UAE — keeping every salary transfer on the right side of MoHRE regulations.",
    },
    {
      icon: Zap,
      title: "Fast Setup & Onboarding",
      desc: "Submit your KYC documents and start processing salaries in days. No long waits, no IT overhead, no missed paydays.",
    },
    {
      icon: Smartphone,
      title: "Anywhere Access",
      desc: "Run payroll from the office or on the go. Manage salaries, balances and cards from desktop or mobile, 24/7.",
    },
    {
      icon: HeartHandshake,
      title: "Superior Employee Experience",
      desc: "From card delivery to offboarding, your employees get the C3Pay app, salary advance options and multilingual support.",
    },
    {
      icon: ReceiptText,
      title: "Transparent Pricing",
      desc: "One simple invoice with clear pricing and zero hidden fees. Built to scale with companies of every size.",
    },
    {
      icon: LayoutDashboard,
      title: "Payroll Designed for You",
      desc: "Issue salary cards, schedule WPS payroll runs and track transfer status in real-time from a single dashboard.",
    },
  ];
  return (
...
function Platform() {
  const rows = [
    {
      img: IMG.dash1,
      title: "Know when your salary funds are credited",
      desc: "Track transferred funds and view available balance in real-time. No more guessing or follow-up calls to the bank.",
    },
    {
      img: IMG.dash2,
      title: "Live salary transfer status",
      desc: "Stay up-to-date the moment your team is paid. You'll never be in the dark on a WPS submission again.",
    },
    {
      img: IMG.better1,
      title: "Work closer with your team",
      desc: "Invite finance, HR and admin users to the platform with role-based access for tighter collaboration.",
    },
    {
      img: IMG.better2,
      title: "Approval flows you control",
      desc: "Configure custom approval workflows so payroll runs are reviewed and signed-off before they go out.",
    },
    {
      img: IMG.dash3,
      title: "Schedule payroll on your terms",
      desc: "Avoid the month-end rush. Schedule salary processing exactly when it suits your cashflow and pay cycle.",
    },
    {
      img: IMG.better4,
      title: "Payroll history at your fingertips",
      desc: "Automated, audit-ready payroll reports — search any month, any employee, any salary transfer instantly.",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 text-3xl lg:text-5xl font-bold text-navy">
            Modern payroll tech, built for UAE finance teams
          </h2>
          <p className="mt-4 text-lg text-muted-foreground">
            ...
            >
              <div className="relative">
                ...
                <img
                  ...
                  alt={r.title}
                  loading="lazy"
                  className="relative w-full h-auto rounded-2xl shadow-elegant bg-background"
                />
              </div>
              <div>
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8 grid lg:grid-cols-12 gap-12">
        <div className="lg:col-span-5">
          ...
          <h2 className="mt-3 text-3xl lg:text-5xl font-bold">
            Stay 100% WPS compliant — without the spreadsheets
          </h2>
...
function EmployeeValue() {
  const benefits = [
    ...
    { title: "24/7 support", desc: "Multilingual support via call, email and WhatsApp for every employee." },
  ];
  return (
    <section className="py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-5">
            ...
            <h2 className="mt-3 text-3xl lg:text-5xl font-bold text-navy">
              A salary card your people actually want
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
            ...
            <img
              ...
              loading="lazy"
              className="mt-8 rounded-2xl shadow-elegant w-full max-w-sm"
            />
          </div>
...
function FAQ() {
  const faqs = [
    {
      q: "What is WPS and is Edenred Payroll WPS-compliant?",
      a: "The Wage Protection System (WPS) is an electronic salary transfer system mandated by the UAE Ministry of Human Resources and Emiratisation (MoHRE). Edenred Payroll is fully WPS-compliant and MoHRE authorised, with no minimum salary requirement.",
    },
    {
      q: "How does the Edenred salary card work for employees?",
      a: "Every employee receives a Mastercard-powered C3Pay payroll card. Salaries are credited directly to the card and employees can withdraw cash at any ATM, pay online or in-store worldwide, send money home and recharge mobiles in 130+ countries.",
    },
    {
      q: "How quickly can my business start running payroll?",
      a: "Once your KYC documents are submitted, onboarding takes a matter of days. You can begin issuing payroll cards and processing salaries from the dashboard as soon as activation is complete.",
    },
    {
      q: "Is there a minimum company size or minimum salary?",
      a: "No. Edenred Payroll works for businesses of every size, with no minimum salary requirement — both WPS and non-WPS payrolls are supported.",
    },
    {
      q: "How much does Edenred Payroll cost?",
      a: "Pricing is transparent and tailored to your headcount and payroll volume. You receive a single, clear invoice with no hidden fees. Book a demo and our team will share pricing for your business.",
    },
  ];
  return (
    <section id="faq" className="py-20 lg:py-28 bg-soft">
      <div className="mx-auto max-w-4xl px-5 lg:px-8">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h2 className="mt-3 text-3xl lg:text-5xl font-bold text-navy">
            WPS payroll & salary card questions, answered
          </h2>
        </div>
        <div className="mt-12 space-y-3">
          {faqs.map((f) => (
            <details
              key={f.q}
              className="group rounded-2xl border border-border bg-card p-5 shadow-card open:shadow-elegant transition-shadow"
            >
              <summary className="flex cursor-pointer items-center justify-between gap-4 text-navy font-semibold list-none">
                <span>{f.q}</span>
                <span className="h-7 w-7 rounded-full bg-accent text-primary grid place-items-center group-open:rotate-45 transition-transform text-xl leading-none">
                  +
                </span>
              </summary>
...
function DemoForm() {
  ...
  return (
    <section id="demo" className="py-20 lg:py-28 bg-navy-deep text-primary-foreground relative overflow-hidden">
      <div
      ...
      <div className="relative mx-auto max-w-7xl px-5 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="mt-3 text-3xl lg:text-5xl font-bold">
            See WPS payroll & salary cards in action
          </h2>
          <p className="mt-4 text-lg text-primary-foreground/80 max-w-lg">
          ...
          <ul className="mt-8 space-y-3 text-sm">
            {[
              "Live demo of the payroll dashboard",
              "Tailored pricing for your headcount",
              "Onboarding & WPS migration walkthrough",
            ].map((t) => (
        ...
        <div className="rounded-3xl bg-background text-foreground p-7 lg:p-9 shadow-elegant">
          {submitted ? (
            ...
            >
              ...
              <a
                href="https://wa.me/971564016582"
                className="w-full inline-flex items-center justify-center gap-2 rounded-full border border-border bg-background px-6 py-3.5 text-sm font-semibold text-navy hover:bg-muted"
              >
                <PhoneCall className="h-4 w-4 text-primary" /> Or chat with Sales on WhatsApp
              </a>
    ...
    <footer className="border-t border-border bg-background">
      <div className="mx-auto max-w-7xl px-5 lg:px-8 py-12 grid md:grid-cols-3 gap-8">
        ...
        <div className="text-sm text-muted-foreground">
          ...
          <ul className="space-y-2">
            <li><a href="#demo" className="hover:text-primary">Book a free demo</a></li>
            <li><a href="https://wa.me/971564016582" className="hover:text-primary">WhatsApp Sales</a></li>
